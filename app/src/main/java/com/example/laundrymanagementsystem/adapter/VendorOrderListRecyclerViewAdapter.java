...
public class VendorOrderListRecyclerViewAdapter extends RecyclerView.Adapter<VendorOrderListRecyclerViewAdapter.ViewHolder> {

    Context context;

    public VendorOrderListRecyclerViewAdapter(Context context) {
        this.context = context;
    }

    @NonNull
    @Override
    public VendorOrderListRecyclerViewAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.shape_vendor_order_list, parent, false);
        ViewHolder holder = new ViewHolder(view);
        return holder;
    }

    @Override
    public void onBindViewHolder(@NonNull VendorOrderListRecyclerViewAdapter.ViewHolder holder, int position) {
